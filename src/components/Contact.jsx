    ...
    return(
        <div name='contact' className="w-full sm:h-screen h-screen bg-[#0a192f] flex justify-center items-center p-4">
            <form action="https://getform.io/f/32bc0b7a-81c9-49ca-a984-52c1fcdc0724" method="post" className="flex flex-col max-w-[600px] w-full"> 
                ...
                <button className="text-white border-2 hover:bg-[#ffff7f] hover:text-black px-4 py-3 my-8 mx-auto flex items-center" type={["submit","reset"]}>Let's Collaborate</button>
            </form>
        </div>
    )
}
